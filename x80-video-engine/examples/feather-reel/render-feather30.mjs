...
} from './plan-feather30.mjs';

const DIR = dirname(fileURLToPath(import.meta.url));
const OUT = join(DIR, '../../output/feather30');
...
for (const f of [90, 178, 270, 450, 630, 810, 885]) {
...
writeFileSync(join(OUT, 'feather-x80-30s.mp4'), mp4);
