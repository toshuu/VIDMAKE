...
const waveRange = [0, 15, 30, 45, 60, 75, 89];
...
export function buildFeatherReel(measure) {
  ...
  return {
    composition: {
      id: 'feather-x80-15s', width: W, height: H, fps: 30, durationInFrames: DUR,
      root: {
        ...
        children: [
              ...
              kickCentered('a1-kick', 'GLOBAL LAUNCH SOON', 140),
              {
                ...
                children: [
                  ...
                  // Satellite: explicit keyframed orbit (200° over the act).
                  {
                    ...
                    x: anim([0, 15, 30, 45, 60, 75, 89], [106, 87, 37, -29, -87, -118, -113], Easing.linear),
                    y: anim([0, 15, 30, 45, 60, 75, 89], [-7, 56, 97, 104, 73, 15, -46], Easing.linear),
          ...
          // ACT 4 — 25 languages + marquee band (local 12..89)
          {
            ...
            children: [
              ...
              {
                id: 'a4-band', type: 'rect', width: W, height: 64, x: 0, y: 786,
                fill: 'rgba(255,255,255,0.08)', stroke: 'rgba(255,255,255,0.15)', strokeWidth: 1,
                backdropBlur: 5, opacity: fade(30, 44),
              },
              {
                id: 'a4-mq', type: 'text',
                text: 'ESPA\u00d1OL \u2022 FRAN\u00c7AIS \u2022 DEUTSCH \u2022 ITALIANO \u2022 PORTUGU\u00caS \u2022 POLSKI \u2022 T\u00dcRK\u00c7E \u2022 DUTCH \u2022 SWEDISH \u2022 HINDI \u2022 ENGLISH \u2022 ESPA\u00d1OL \u2022 FRAN\u00c7AIS \u2022 DEUTSCH \u2022 ',
                fontFamily: DISP, fontSize: 30, fontWeight: 700, fill: 'rgba(255,255,255,0.85)',
                x: anim([0, 89], [540, -1500], Easing.linear), y: 795, opacity: fade(30, 44),
              },
              {
                id: 'a4-globe', type: 'svg', svg: SVG_GLOBE, width: 40, height: 40,
                x: 20, y: 798, opacity: fade(30, 44),
              },
              actBadge('a4-badge', 4),
              grainNode('a4-grain', 90),
            ],
          },
    ...
    timeline: seq(0, DUR, [
      seq(0, 82, [leaf('act1')]),
      { kind: 'transition', from: 82, durationInFrames: 12, type: 'slide', params: { direction: 'left' }, a: 'act1', b: 'act2', aFreeze: 81, easing: 'ease-in-out' },
      { kind: 'sequence', from: 94, durationInFrames: 78, trimBefore: 12, children: [leaf('act2')] },
      { kind: 'transition', from: 172, durationInFrames: 12, type: 'dissolve', a: 'act2', b: 'act3', aFreeze: 89, easing: 'ease-in-out' },
      { kind: 'sequence', from: 184, durationInFrames: 78, trimBefore: 12, children: [leaf('act3')] },
      { kind: 'transition', from: 262, durationInFrames: 12, type: 'slide', params: { direction: 'left' }, a: 'act3', b: 'act4', aFreeze: 89, easing: 'ease-in-out' },
      { kind: 'sequence', from: 274, durationInFrames: 78, trimBefore: 12, children: [leaf('act4')] },
      { kind: 'transition', from: 352, durationInFrames: 12, type: 'zoom-blur', a: 'act4', b: 'act5', aFreeze: 89, easing: 'ease-in-out' },
      { kind: 'sequence', from: 364, durationInFrames: 86, trimBefore: 12, children: [leaf('act5')] },
