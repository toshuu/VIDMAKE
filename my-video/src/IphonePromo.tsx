...
/* ------------------------------------------------------------------ */
/* Scene 1 — Animated title: "Introducing iPhone" (0 – 2.5s)           */
/* ------------------------------------------------------------------ */
    ...
    >
      ...
      <Interactive.Div
        ...
        style={{
          ...
          width: interpolate(frame, [30, 55], [0, 420], { ...clamp, easing: EASE }),
...
const FeatureRow: React.FC<{ index: number; title: string; sub: string }> = ({
  index,
  title,
  sub,
}) => {
  ...
  return (
    <Interactive.Div
      ...
      style={{
        ...
        translate: interpolate(frame, [start, start + 16], ["-70px 0px", "0px 0px"], {
          ...clamp,
          easing: EASE,
        }),
      }}
    >
      ...
      <div>
        <Interactive.Div
          ...
          style={{ fontFamily: FONT, fontWeight: 700, fontSize: 72, color: "#f5f5f7" }}
        >
          {title}
        </Interactive.Div>
        <Interactive.Div
          name={`Feature${index + 1}Sub`}
          style={{ fontFamily: FONT, fontSize: 44, color: "#86868b" }}
        >
          {sub}
        </Interactive.Div>
      </div>
...
const FeaturesScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {FEATURES.map((f, i) => (
        <FeatureRow key={f.title} index={i} title={f.title} sub={f.sub} />
      ))}
    </AbsoluteFill>
  );
};
...
/* ------------------------------------------------------------------ */
/* Scene 3 — CSS iPhone reveal + "Beyond Pro." (6 – 8.5s)              */
/* ------------------------------------------------------------------ */
  ...
  return (
    <Interactive.Div
      ...
      style={{
        ...
        translate: interpolate(frame, [5, 38], ["220px 0px", "0px 0px"], {
          ...clamp,
          easing: SPRING,
        }),
        rotate: interpolate(frame, [5, 38], ["8deg", "0deg"], {
          ...clamp,
          easing: SPRING,
        }),
      }}
      ...
      <div>
        <Interactive.Div
          ...
          style={{
            ...
            color: "#f5f5f7",
            opacity: interpolate(frame, [0, 12], [0, 1], { ...clamp, easing: EASE }),
            translate: interpolate(frame, [0, 18], ["-60px 0px", "0px 0px"], {
              ...clamp,
              easing: EASE,
            }),
          }}
        ...
        <Interactive.Div
          ...
          style={{
            ...
            translate: interpolate(frame, [10, 28], ["-60px 0px", "0px 0px"], {
              ...clamp,
              easing: EASE,
            }),
          }}
...
export const IphonePromo: React.FC = () => {
  ...
  return (
    <AbsoluteFill name="IphonePromo" style={{ backgroundColor: "#000000" }}>
